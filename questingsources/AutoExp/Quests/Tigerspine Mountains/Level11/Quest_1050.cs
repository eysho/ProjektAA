    ...
    internal class Quest_1050 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                if (!host.movementModule.GpsMove("Tiger_Yarut")) return false;
                Thread.Sleep(1000);
                host.UseDoodadSkill(11976, host.getNearestDoodad(2314), true);
                Thread.Sleep(1000);
                host.UseDoodadSkill(11976, host.getNearestDoodad(2315), true);
                Thread.Sleep(1000);
                host.UseDoodadSkill(11976, host.getNearestDoodad(2316), true);
            }
